...
function Textarea({ className, ...props }: React.ComponentProps<"textarea">) {
  return (
    <textarea
      data-slot="textarea"
      className={cn(
        "rqti:file:text-foreground rqti:placeholder:text-muted-foreground rqti:selection:bg-primary rqti:selection:text-primary-foreground rqti:dark:bg-input/30 rqti:border-input rqti:flex rqti:min-h-[60px] rqti:w-full rqti:min-w-0 rqti:rounded-md rqti:border rqti:bg-transparent rqti:px-3 rqti:py-2 rqti:text-sm rqti:shadow-xs rqti:transition-[color,box-shadow] rqti:outline-none rqti:disabled:pointer-events-none rqti:disabled:cursor-not-allowed rqti:disabled:opacity-50",
