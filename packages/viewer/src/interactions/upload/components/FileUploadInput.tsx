...
function FileUploadInput({
  ...
  return (
    <div className="qti-ext-upload">
      ...
      >
        <div className="rqti:flex rqti:flex-col rqti:items-center rqti:justify-center">
          <svg
          ...
          <p className="qti-ext-upload-text">
            <span className="rqti:font-semibold">파일을 클릭하거나 드래그하여 업로드</span>
          </p>
