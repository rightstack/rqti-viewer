...
export const FeedbackModal = ({
  ...
  if (isSample) {
    ...
    return (
      <div className="rqti:absolute rqti:inset-0 rqti:z-100">
        {/* Backdrop */}
        <div
          className="rqti:absolute rqti:inset-0 rqti:bg-black/50"
          role="button"
          tabIndex={0}
        ...
        >
          <div className="qti-ext-feedback-modal-content">
            <div className="rqti:flex-shrink-0">
            ...
            {typeof description === "string" ? (
              <div
                ...
                className="qti-ext-feedback-description rqti:flex-1 rqti:overflow-y-auto"
            ...
            <div className="rqti:flex-shrink-0">{renderButtons()}</div>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className={cn("qti-ext-feedback-modal", "rqti:max-w-lg")}
        style={themeVariables as React.CSSProperties}
      >
        <DialogHeader>
